...
--    the brand is not in the Brands table.)
        SELECT Models.brand_name, Models.name, Models.year, Brands.founded
        ...> FROM Models
        ...> JOIN Brands ON Models.brand_name = Brands.name
...
-- left joins and inner joins.
    Left joins will list out all possible options on the first table and second tables information
    will be NULL.
    Inner joins will only give you the options that are in both tables.
